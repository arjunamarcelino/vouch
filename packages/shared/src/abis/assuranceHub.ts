...
export const assuranceHubAbi = [
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct AssuranceHub.AssuranceJob",
        "components": [
          {
            "name": "client",
            "type": "address",
          ...
          {
            "name": "publicCriteriaHash",
            "type": "bytes32",
            "internalType": "bytes32"
          },
          {
            "name": "privateCriteriaCommitment",
            "type": "bytes32",
            "internalType": "bytes32"
          },
          {
            "name": "submissionCommitment",
            "type": "bytes32",
            "internalType": "bytes32"
          },
          {
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum AssuranceHub.State"
          }
        ]
      }
    ],
  ...
  {
    "type": "event",
    "name": "ConfidentialEvaluationResolved",
    "inputs": [
      {
        "name": "jobId",
        "type": "uint256",
  ...
  {
    "type": "event",
    "name": "InitialEvaluationResolved",
    "inputs": [
      {
        "name": "jobId",
        "type": "uint256",
