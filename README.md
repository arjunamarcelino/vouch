...
| **Chainlink** — Best Confidential Workflow | $2,000 | `packages/cre-workflow` runs the private regression test inside a TEE; the enclave verdict is the sole gate on the guarantee payout. |
